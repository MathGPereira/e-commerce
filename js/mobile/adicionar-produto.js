export default function adicionaProduto(preco, quantidade) {
    ...
    if(quantidade !== "0") {
        ...
        menuCarrinho.innerHTML = `
            ...
            <div class="carrinho-compras__corpo">
                ...
                <svg width="14" height="20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="corpo__delete">
                    <defs>
