export function criaDialog() {
    const dialog = `
        ...
        <i>
            <svg width="12" height="18" xmlns="http://www.w3.org/2000/svg" class="seta-esquerda dialog__seta" data-seta="-">
        ...
        <i>
            <svg width="13" height="18" xmlns="http://www.w3.org/2000/svg" class="seta-direita dialog__seta" data-seta="+">
